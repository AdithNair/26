...
Question1=Label(root, text ="Do you gave headache and/or sore throat?")
Question1.pack()
...
Question3.pack()
question3_r1=Radiobutton(root, text = "yes", variable=question3_radioButton, value="no")
question3_r1.pack()
question3_r2=Radiobutton(root, text = "yes", variable=question3_radioButton, value="no")
question3_r2.pack()
def fever_score():
    score = 0
    ...
    if score <= 20:
        ...
        messagebox.showinfo("Report", "You should go to the doctor.")
